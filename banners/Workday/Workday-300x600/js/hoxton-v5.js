...
var setCSS = function (hox) {
    ...
    for (var key1 in hox.data.hoxtonSettings) {
        kys = Object.keys(hox.data.hoxtonSettings[key1])[0];
        vals = Object.values(hox.data.hoxtonSettings[key1])[0]+"px";
        // console.log(kys, vals, key1)
        document.getElementById(key1).style[kys] = vals;
    };
...
var hoxton = {
    ...
    init: function () {
        ...
        if (hoxton.data.metadata) {
            ...
            if((window.location.protocol == "file:") && !hoxton.inIframe()){
                var iFrame = document.createElement("iframe");
                iFrame.style.width="".concat(hoxton.data.adSize.width,"px")
                iFrame.style.height="".concat(hoxton.data.adSize.height,"px")
